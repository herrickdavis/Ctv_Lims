    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (!results || results.length === 0) {
          ...
          //$("#alertModalBody").text(JSON.stringify(results));
          //$("#alertModal").modal("show");
        }
        // Hacer una petición AJAX a generarTabla.php
        $.ajax({
          url: "../Pages/generaTabla.php",
          type: "post",
          data: { resultados: JSON.stringify(results) },
          success: function (data) {
            // Inserta la tabla en el div donde quieres que aparezca
            $("#divTabla").html(data);
          },
        });
      },
